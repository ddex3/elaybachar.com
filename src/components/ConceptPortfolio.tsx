...
interface ConceptPortfolioProps {
  items: PortfolioItem[];
}

const ConceptPortfolio: React.FC<ConceptPortfolioProps> = ({ items }) => {
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 id="concept-title" className="text-5xl md:text-7xl font-thin tracking-wider mb-6 text-gray-900">
              CONCEPT
            </h2>
          ...
          >
            {imageErrors.has(items[currentIndex]?.id || 0) ? (
              ...
              <motion.img
                ...
                alt={`${items[currentIndex]?.title} - Featured concept`}
            ...
            <div className="absolute top-6 right-6 flex space-x-3 pointer-events-none">
              <motion.button
                ...
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.95 }}
                aria-label={likedItems.has(items[currentIndex]?.id) ? "Unlike concept" : "Like concept"}
              >
                <Heart 
...
export default ConceptPortfolio;
